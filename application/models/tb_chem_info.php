...
class tb_chem_info extends CI_Model {
    ...
    public function update_chem($chem_no, $chem_cas_number, $chem_seq, $chem_type, $chem_name_th, $chem_name_en, $chem_qty_in, $chem_qty_in_msm, $chem_qty_boh, $chem_qty_boh_msm, $chem_location,$filename_msds,$filename_label, $user_id, $date) {
        ...
        if($filename_msds != "")
        {
              $this->db->set('chem_msds_file', $filename_msds);
        }
        if($filename_label != "")
        {
              $this->db->set('chem_label_file', $filename_label);
        }
