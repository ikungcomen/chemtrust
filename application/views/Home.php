            ...
            <nav class="navbar navbar-default" role="navigation">
                <div class="navbar-header">
                            ...
                            <ul class="nav navbar-nav pull-right">
                                <li class="active"><a href="<?php echo base_url()?>index.php/assessment_risk/assessment_risk_controller/excel"><i class="glyphicon glyphicon-log-in"></i>&nbsp;&nbsp;Export Excel</a></li>
                            </ul>
...
<div class="container">
    ...
    <?php foreach ($rs->result() as $row): ?>
        ...
        <tr><td></td><td><?php echo $row->chem_no ?></td><td></td></tr>
