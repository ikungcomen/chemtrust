...
<div class="col-md-9">
    <div class=mo"row">
        <div class="col-sm-12">
            ...
            <div class="col-sm-11">
                <h4 class="font-title"><b>ประเมินความเสี่ยง(แก้ไข)</b></h4>
            </div>
            <hr width="100%">            
            <div class="panel-body form-horizontal payment-form">
                <form id="search_classify_frm" method="post" action="<?php echo base_url(); ?>index.php/assessment_risk/assessment_risk_controller/update">                
                    <input type ="hidden" id="cmd" name="cmd">
                    <fieldset>  

                        <div class="form-group">
                             <div class="col-sm-6 text-left">
                                <a id="back_classify_btn" class="btn btn-success" href="<?php echo base_url(); ?>index.php/assessment_risk/assessment_risk_controller/search/<?php echo $chem_no?>">
                        ...
                        <div class="form-group">                            
                            ...
                            <input type="hidden" id="chem_cas_number" name="chem_cas_number"  value="<?php echo $chem_cas_number ?>"/>
                        </div>
                        <div class="form-group">                            
                            ...
                            <div class="col-sm-9">
                                 <select class="form-control request" id="chem_con_lvl_no" name="chem_con_lvl_no">                                   
                                    <?php foreach ($cl as $row) { ?>                                        
                                        <option value="<?php echo $row['chem_con_lvl_no']; ?>" <?php echo ($row['chem_con_lvl_no']==$chem_con_lvl_no)?"selected='true'":""; ?>><?php echo $row['chem_con_lvl_no']."=".$row['chem_con_lvl_name']; ?></option>
                                    <?php } ?>
                                </select> 
                            </div> 
                        </div>  
                            ...
                            <div class="col-sm-9">
                                 <select class="form-control request" id="chem_seq_lvl_no" name="chem_seq_lvl_no">                                   
                                    <?php foreach ($sl as $row) { ?>                                        
                                        <option value="<?php echo $row['chem_seq_lvl_no']; ?>" <?php echo ($row['chem_seq_lvl_no']==$chem_seq_lvl_no)?"selected='true'":""; ?>><?php echo $row['chem_seq_lvl_no']."=".$row['chem_seq_lvl_name'].",".$row['chem_seq_lvl_desc']; ?></option>
                                    <?php } ?>
                                </select> 
                            </div> 
                        </div>  
                            ...
                            <div class="col-sm-9">
                                 <select class="form-control request" id="chem_haz_eff_hea_no" name="chem_haz_eff_hea_no">                                   
                                    <?php foreach ($heh as $row) { ?>                                        
                                        <option value="<?php echo $row['chem_haz_eff_hea_no']; ?>" <?php echo ($row['chem_haz_eff_hea_no']==$chem_haz_eff_hea_no)?"selected='true'":""; ?>><?php echo $row['chem_haz_eff_hea_no']."=".$row['chem_haz_eff_hea_name'].",".$row['chem_haz_eff_hea_desc'];; ?></option>
                                    <?php } ?>
                                </select> 
                            </div> 
                        </div> 
