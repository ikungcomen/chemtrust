...
//--control view and asign data
   if ($model[0]['method'] == 'edit') {
        ...
        $chem_con_lvl_no =$model[0]['data']['data'][0]['chem_con_lvl_no'];
        $chem_con_lvl_name =$model[0]['data']['data'][0]['chem_con_lvl_name'];  
        ...
        $chem_con_lvl_no =$model[0]['data']['data'][0]['chem_con_lvl_no'];
        $chem_con_lvl_name =$model[0]['data']['data'][0]['chem_con_lvl_name'];  
        $chem_con_lvl_desc =$model[0]['data']['data'][0]['chem_con_lvl_desc'];  
        $create_date=$model[0]['data']['data'][0]['create_date_fmt'];;
        $create_userid=$model[0]['data']['data'][0]['create_userid'];;
...
<div class="col-md-9">
    <div class=mo"row">
        <div class="col-sm-12">
            ...
            <div class="col-sm-11">
                <h4 class="font-title"><b>ประเมินระดับความเข้มข้น<?php echo $event_msg;?></b></h4>
            </div>
            <hr width="100%">            
            <div class="panel-body form-horizontal payment-form">
                <form id="maintain_frm" method="post" action="<?php echo base_url(); ?>index.php/con_lvl/con_lvl_controller/con_lvl_event">                
                    <input type ="hidden" id="cmd" name="cmd" <?php echo "value='" . $method . "'"; ?>> 
                    <input type ="hidden" id="chem_con_lvl_no_hid" name="chem_con_lvl_no_hid" value='<?php echo $chem_con_lvl_no ?>'>  
                    <fieldset>  
                         
                        <div class="form-group ">
                            <div class="col-sm-6 text-lefft">                                
                                <a id="back_btn" class="btn btn-primary" href="<?php echo base_url(); ?>index.php/con_lvl/con_lvl_controller/con_lvl">
                        ...
                        <div class="form-group text-center">
                            ...
                            <div class="col-sm-3">
                                <input class="form-control request" type="number" id="chem_con_lvl_no" name="chem_con_lvl_no"  placeholder="ระดับ"  <?php if($model[0]['method'] == 'edit') echo "disabled='true'"; ?>  value="<?php echo $chem_con_lvl_no ?>"/>
                            </div>                            
                        </div>
                        
                        <div class="form-group text-center">
                            <label  class="col-sm-3 control-label">ค่าเฉลี่ยความเข้มข้นสารเคมีอันตรายที่ผู้ปฏิบัติงานสัมผัส :</label>
                            <div class="col-sm-9">
                                <input class="form-control " type="text" id="chem_con_lvl_name" name="chem_con_lvl_name"    placeholder="ความรุนแรง" value="<?php echo $chem_con_lvl_name ?>"/>
                            </div>                            
                        </div>                       
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#save_btn").click(function() {
            ...
            var chem_con_lvl_no = $('#chem_con_lvl_no').val().trim();
            ...
            if (chem_con_lvl_no == "") {
                $('#message').html('กรุณาระบุ ระดับความรเข้มข้น');
                $('#myModal').modal('show');
