...
<div class="col-md-9">
    <div class=mo"row">
        <div class="col-sm-12">
            ...
            <div class="col-sm-11">
                <h4 class="font-title"><b>ประเมินความรุนแรง(ค้นหา)</b></h4>
            </div>
            <hr width="100%">            
            <div class="panel-body form-horizontal payment-form">
                <form id="ml_frm" method="post" action="<?php echo base_url(); ?>index.php/haz_eff_hea/haz_eff_hea_controller/search_list">                
                    ...
                    <fieldset>  
                        ...
                        <div class="form-group">                           
                            ...
                            <div class="col-sm-6 text-right">  
                                ...
                                <a id="add_btn" class="btn btn-success" href="<?php echo base_url(); ?>index.php/haz_eff_hea/haz_eff_hea_controller/haz_eff_hea_go_add">
                        ...
                        <div class="form-group text-center"> 
                            <div class="col-sm-12"> 
                                <table class="myTable_style" style="table-layout: fixed;">
                                    <thead>                               
                                        <tr>
                                            <th style="width: 7%;text-align: center" >ระดับ</th>
                                            <th style="width: 30%;text-align: center">ความรุนแรง</th>
                                            <th style="width: 30%;text-align: center">ผลกระทบต่อสุขภาพ</th>                                           
                                        ...
                                        if ($model[0]['method'] != 'main') {
                                            if ($model[0]['method'] == 'haveRow') {
                                                ...
                                                foreach ($data as $value) {
                                                    echo "<tr>";
                                                    echo "<td style='word-wrap:break-word;'>" . $value['chem_haz_eff_hea_no'] . "</td>";
                                                    echo "<td style='word-wrap:break-word;'><small>" . $value['chem_haz_eff_hea_name'] . "</small></td>";
                                                    echo "<td style='word-wrap:break-word;'><small>" . $value['chem_haz_eff_hea_desc'] . "<small></td>";                                                   
                                                    ?>
                                                <td>

                                                    <a id="edit_btn" class="btn btn-warning btn-mini" href="<?php echo base_url(); ?>index.php/haz_eff_hea/haz_eff_hea_controller/haz_eff_hea_go_edit/<?php echo $value['chem_haz_eff_hea_no']; ?>">
                                                        <span class="glyphicon glyphicon-edit  fa-1x" aria-hidden="true"></span>
                                                    </a>

                                                    <a id="rmv_btn" class="btn btn-danger" href="<?php echo base_url(); ?>index.php/haz_eff_hea/haz_eff_hea_controller/delete/<?php echo $value['chem_haz_eff_hea_no']; ?>">
