...
//--control view and asign data
   if ($model[0]['method'] == 'edit') {
        ...
        $chem_haz_eff_hea_no =$model[0]['data']['data'][0]['chem_haz_eff_hea_no'];
        $chem_haz_eff_hea_name =$model[0]['data']['data'][0]['chem_haz_eff_hea_name'];  
        $chem_haz_eff_hea_desc =$model[0]['data']['data'][0]['chem_haz_eff_hea_desc'];  
...
<div class="col-md-9">
    <div class=mo"row">
        <div class="col-sm-12">
            ...
            <div class="col-sm-11">
                <h4 class="font-title"><b>ประเมินความรุนแรง<?php echo $event_msg;?></b></h4>
            </div>
            <hr width="100%">            
            <div class="panel-body form-horizontal payment-form">
                <form id="maintain_frm" method="post" action="<?php echo base_url(); ?>index.php/haz_eff_hea/haz_eff_hea_controller/haz_eff_hea_event">                
                    <input type ="hidden" id="cmd" name="cmd" <?php echo "value='" . $method . "'"; ?>> 
                    <input type ="hidden" id="chem_haz_eff_hea_no_hid" name="chem_haz_eff_hea_no_hid" value='<?php echo $chem_haz_eff_hea_no ?>'>  
                    <fieldset>  
                         
                        <div class="form-group ">
                            <div class="col-sm-6 text-lefft">                                
                                <a id="back_btn" class="btn btn-primary" href="<?php echo base_url(); ?>index.php/haz_eff_hea/haz_eff_hea_controller/haz_eff_hea">
                        ...
                        <div class="form-group text-center">
                            ...
                            <div class="col-sm-3">
                                <input class="form-control request" type="number" id="chem_haz_eff_hea_no" name="chem_haz_eff_hea_no"  placeholder="ระดับ"  <?php if($model[0]['method'] == 'edit') echo "disabled='true'"; ?>  value="<?php echo $chem_haz_eff_hea_no ?>"/>
                            </div>                            
                        </div>
                        
                        <div class="form-group text-center">
                            <label  class="col-sm-3 control-label">ควารุนแรง :</label>
                            <div class="col-sm-9">
                                <input class="form-control " type="text" id="chem_haz_eff_hea_name" name="chem_haz_eff_hea_name"    placeholder="ความรุนแรง" value="<?php echo $chem_haz_eff_hea_name ?>"/>
                            </div>                            
                        </div>                        
                        
                        
                         <div class="form-group text-center">
                            <label  class="col-sm-3 control-label">ผลกระทบต่อสุขภาพ :</label>
                            <div class="col-sm-9">
                                <textarea class="form-control " type="text" id="chem_haz_eff_hea_desc" name="chem_haz_eff_hea_desc"    placeholder="ผลกระทบต่อุขภพ" ><?php echo $chem_haz_eff_hea_desc ?></textarea>
                            </div>                            
                        </div> 
                       <hr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#save_btn").click(function() {
            ...
            var chem_haz_eff_hea_no = $('#chem_haz_eff_hea_no').val().trim();
            ...
            if (chem_haz_eff_hea_no == "") {
                $('#message').html('กรุณาระบุ ระดับความรุนแรง');
                $('#myModal').modal('show');
