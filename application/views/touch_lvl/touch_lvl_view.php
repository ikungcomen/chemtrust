...
<div class="col-md-9">
    <div class=mo"row">
        <div class="col-sm-12">
            ...
            <div class="col-sm-11">
                <h4 class="font-title"><b>ระดับการรับสัมผัส(ค้นหา)</b></h4>
            </div>
            <hr width="100%">            
            <div class="panel-body form-horizontal payment-form">
                <form id="ml_frm" method="post" action="<?php echo base_url(); ?>index.php/touch_lvl/touch_lvl_controller/search_list">                
                    ...
                    <fieldset>  
                        ...
                        <div class="form-group">                           
                            ...
                            <div class="col-sm-6 text-right">  
                                ...
                                <a id="add_btn" class="btn btn-success" href="<?php echo base_url(); ?>index.php/touch_lvl/touch_lvl_controller/touch_lvl_go_add">
                        ...
                        <div class="form-group text-center"> 
                            <div class="col-sm-12"> 
                                <table class="myTable_style" style="table-layout: fixed;">
                                    <thead>                               
                                        <tr>
                                            <th style="width: 25%;text-align: center" >คะแนน</th>
                                            <th style="width: 30%;text-align: center">ผล</th>
                                            <th style="width: 30%;text-align: center">ระดับ</th>                                           
                                        ...
                                        if ($model[0]['method'] != 'main') {
                                            if ($model[0]['method'] == 'haveRow') {
                                                ...
                                                foreach ($data as $value) {
                                                    echo "<tr>";
                                                    echo "<td style='word-wrap:break-word;'>" . $value['chem_touch_lvl_bno'] ."ถึง".$value['chem_touch_lvl_eno']. "</td>";
                                                    echo "<td style='word-wrap:break-word;'><small>" . $value['chem_touch_lvl_name'] . "</small></td>";
                                                    echo "<td style='word-wrap:break-word;'><small>" . $value['chem_touch_lvl_desc'] . "<small></td>";                                                   
                                                    ?>
                                                <td>

                                                    <a id="edit_btn" class="btn btn-warning btn-mini" href="<?php echo base_url(); ?>index.php/touch_lvl/touch_lvl_controller/touch_lvl_go_edit/<?php echo $value['chem_touch_lvl_no']; ?>">
                                                        <span class="glyphicon glyphicon-edit  fa-1x" aria-hidden="true"></span>
                                                    </a>

                                                    <a id="rmv_btn" class="btn btn-danger" href="<?php echo base_url(); ?>index.php/touch_lvl/touch_lvl_controller/delete/<?php echo $value['chem_touch_lvl_no']; ?>">
