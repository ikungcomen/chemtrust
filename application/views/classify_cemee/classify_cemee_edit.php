...
<div class="col-md-9">
    <div class=mo"row">
        <div class="col-sm-12">
            ...
            <div class="col-sm-11">
                <h4 class="font-title"><b>การจำแนกประเภทสารเคมี(แก้ไข)</b></h4>
            </div>
            <hr width="100%">            
            <div class="panel-body form-horizontal payment-form">
                <form id="search_classify_frm" method="post" action="<?php echo base_url(); ?>index.php/classify_cemee/classifyCemee_controller/update_classify">                
                    <input type ="hidden" id="cmd" name="cmd">
                    <fieldset>  

                        <div class="form-group">
                             <div class="col-sm-6 text-left">
                                <a id="back_classify_btn" class="btn btn-success" href="<?php echo base_url(); ?>index.php/classify_cemee/classifyCemee_controller/search_classify/<?php echo $chem_no?>">
