...
class seq_lvl_controller extends CI_Controller {
	...
	public function seq_lvl(){    
            /*//echo 'xxx';
            $result['model'][] = array('method' => 'main');
             //print_r($chem_classify);
            $this->load->view('include/header');
	    $this->load->view('seq_lvl/seq_lvl_view',$result);
	    $this->load->view('include/footer');
          ...
          public function seq_lvl_go_add(){ 
          $result['model'][]=array('method' => 'add',"message_flag"=>'-',"message"=>'-');         
        
        //print_r($result);
          $this->load->view('include/header');
	  $this->load->view('seq_lvl/seq_lvl_maintain',$result);
	  $this->load->view('include/footer');
                        
	}
        
        
        public function seq_lvl_event(){         
         ...
         if($this->tb_chem_seq_lvl->check_tb_chem_seq_lvl_list()>0)
         {
           $data['data'] = $this->tb_chem_seq_lvl->get_tb_chem_seq_lvl_list();
	  ...
	  $this->load->view('include/footer');
         ...
         public function seq_lvl_go_edit($chem_seq_lvl_no){ 
           // $chem_seq  = $this->input->get('chem_seq');
            //echo  'xxxxx' . $chem_seq;        
             //print_r($chem_classify);
            $this->search($chem_seq_lvl_no);            
	}
         public function search($chem_seq_lvl_no){          
                  
         if($this->tb_chem_seq_lvl->check_tb_chem_seq_lvl($chem_seq_lvl_no)>0)
         {
           $data['data'] = $this->tb_chem_seq_lvl->get_tb_chem_seq_lvl($chem_seq_lvl_no);
	  ...
	  $this->load->view('include/footer');
        ...
        $chem_seq_lvl_no = $this->input->post('chem_seq_lvl_no_hid');
        $chem_seq_lvl_name= $this->input->post('chem_seq_lvl_name'); 
        $chem_seq_lvl_desc= $this->input->post('chem_seq_lvl_desc');        
        //
        ...
        $date = date('y-m-d'); 
         ...
         if($this->tb_chem_seq_lvl->check_tb_chem_seq_lvl($chem_seq_lvl_no)>0)
         {
           $resultUpdate = $this->tb_chem_seq_lvl->update_tb_chem_seq_lvl($chem_seq_lvl_no,$chem_seq_lvl_name,$chem_seq_lvl_desc,$user_id, $date);
           if($resultUpdate > 0)
           {
               $data['data'] = $this->tb_chem_seq_lvl->get_tb_chem_seq_lvl($chem_seq_lvl_no);
	...
	$this->load->view('include/footer');     
        ...
        $date = date('y-m-d'); 
         ...
         if($this->tb_chem_seq_lvl->check_tb_chem_seq_lvl($chem_seq_lvl_no)<= 0)
         {
           $resultInsert = $this->tb_chem_seq_lvl->insert_tb_chem_seq_lvl($chem_seq_lvl_no,$chem_seq_lvl_name,$chem_seq_lvl_desc,$user_id, $date);
           if($resultInsert > 0)
           {
               //$data['data'] = $this->tb_chem_seq_lvl->get_tb_tb_chem_seq_lvl($chem_seq);
	...
	$this->load->view('include/footer');     
         ...
         public function delete($chem_seq_lvl_no){ 
        
        //$chem_seq = $this->input->get('chem_seq');    
        
         if($this->tb_chem_seq_lvl->check_tb_chem_seq_lvl($chem_seq_lvl_no)> 0)
         {
           $resultDelete = $this->tb_chem_seq_lvl->delete_tb_chem_seq_lvl($chem_seq_lvl_no);
           if($resultDelete > 0)
           {
